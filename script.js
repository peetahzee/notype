...
var cans = [
	{name: "compile error", content: "Your PA2 submission did not successfully compile on the [course VM](https://github.com/usc-csci102-spring2013/programming_assignments/wiki/Course-VM), therefore, I am unable to fully grade your submission.\n\nThe course policy allows &ndash; in a very limited way &ndash; altering or amending a submission after the deadline. Details are discussed in section 3 of the [submission instructions](https://github.com/usc-csci102-spring2013/programming_assignments/wiki/PA-Submission-Instructions) wiki page.\n\nAfter grading the non-coding part of you PA2 submission, you earned **[notype_placeholder] points**.\n\n>Any and all discussions pertaining to this problem **must** be done via comments on this issue after **re-opening** it. Note that a closed issue implicitly signals that you do not want to discuss this any further. No emails are accepted. You have two weeks from the time of this posting to dispute this deduction. Please allow up to 72 hours for a response to a regrade request. You are expected to follow the _Grading Disputes_ policies outlined in the [course syllabus](http://www-scf.usc.edu/~csci102/syllabus.html)."},
	{name: "deduction applied", content: "PA2 Submission did not successfully fulfill all the requirements for this issue. The following error(s) were encountered:\n  + [notype_placeholder]\n\nA deduction of **[notype_placeholder] points** was applied.\n\n>Any and all discussions pertaining to this deduction **must** be done via comments on this issue. No emails are accepted. You are expected to follow the _Grading Disputes_ policies outlined in the [course syllabus](http://www-scf.usc.edu/~csci102/syllabus.html).\n\n>You have two weeks from the time of this posting to dispute this deduction. Please allow up to 72 hours for a response to a regrade request."},
	{name: "success", content: "PA2 submission successfully fulfilled the requirements for this issue."}
]
